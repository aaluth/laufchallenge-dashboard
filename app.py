...
import numpy as np # Neu importiert für die Gruppierung
...
        # Die Nutzung von oauth2client.service_account.ServiceAccountCredentials ist veraltet und kann bei Updates Fehler verursachen,
        # aber wir verwenden es hier, um zum Ursprungscode zurückzukehren.
...
        # Rückgabe der erwarteten drei DataFrames
...
    # ----------------------------------------------------------------------
    if 'Gruppe' in df_challenge.columns:
        
...
        group_weekly.rename(columns={'KM': 'Wochen_KM'}, inplace=True) # KM heißt hier Wochen_KM
        
...
        
        # Setze 'Wochen_KM' wieder auf 'KM' für Konsistenz (oder behalte es so, ich lasse es hier bei Wochen_KM für die Kumulation)
        # Wichtig: Das Liniendiagramm verwendet 'Kumulierte_KM'
    else:
        group_weekly = pd.DataFrame()

    return df_challenge, weekly_summary, group_weekly # df_challenge wird als "df" im Hauptteil verwendet
...
        # --- 1. Längste Einheit ---
        # Sicherstellen, dass idxmax einen Index zurückgibt
...
        # Hier reindexieren wir, um sicherzustellen, dass alle Gruppen sichtbar sind, auch wenn sie 0 KM haben
...
# KORREKTUR: Die X-Achse zeigt nun alle KWs an, da die Daten in transform_data ergänzt wurden.
# ==============================================================================
